...
with form:
    ...
    account = st.selectbox("Account:", key='account', options=('WeChat', 'Alipay'))

    amt = st.number_input("Amount: (negative for exp, positiv for inc)", key='amt')

    purpose = st.selectbox("Purpose:", key='purpose', options=('帮补', '换汇', 'Transfer to Sugar', 'Transfer to May', 'WeChat to Alipay', 'Alipay to WeChat', 'Others'))
